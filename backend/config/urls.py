...
urlpatterns = [
    ...
    path('api/billing/', include(('apps.billing.urls.billing', 'billing'), namespace='billing')),
    path(
        'api/webhooks/',
        include(('apps.billing.urls.webhooks', 'billing_webhooks'), namespace='billing_webhooks'),
    ),
